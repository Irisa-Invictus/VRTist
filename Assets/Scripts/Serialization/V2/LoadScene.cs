...
{
    [CreateAssetMenu(fileName = "LoadSceneV2", menuName = "VrTist/V2/loader")]
    public class LoadScene : LoadSceneAbstract
    {
        ...
        private void LoadConstraint(ConstraintData data)
        {
            ...
            // Create constraint
            ConstraintManager.AddConstraint(sourceTransform.gameObject, targetTransform.gameObject, data.type, data.positionOffset, data.rotationOffset);
        }
